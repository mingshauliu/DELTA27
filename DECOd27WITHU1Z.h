...
CFunction SU3, SU2, U1, U1R, U1Z, S4, A4, Zn, D27;
...
#do field={Scalar,LHFermion,RHFermion,DiracFermion,FieldStrength,Gravity}
	...
	id `field'(x?,?x1,U1Z(?rep),?x2) = `field'(x,?x1,?x2)*charU1Z(?rep,n);
...
*
#do group={U1,SU2,SU3,A4,S4,D27,U1Z}
...
#do group={U1,U1R,SU2,SU3,Zn,A4,S4,D27,U1Z}
    #do ii=1,1
...
#procedure U1Zsymmetry
*******************************************************
*
*	U(1) ADDITIONAL symmetry
*
*******************************************************
id charU1Z(rep?int_,n?) = x^(rep*n);
.sort
...
Local HS = 1/27*(  
		...
		+ 3*HS*replace_(var00,1,var01,w  ,var02,w^2,var10,1  ,var11,w  ,var12,w^2,var20,1  ,var21,w  ,var22,w^2,var30,1  ,var31,w  ,var32,w^2,varp30,1  ,varp31,w  ,varp32,w^2)
                ...
                + 3*HS*replace_(var00,1,var01,w^2,var02,w  ,var10,w^2,var11,w  ,var12,1  ,var20,w  ,var21,0  ,var22,w^2,var30,1  ,var31,w^2,var32,w  ,varp30,1  ,varp31,w^2,varp32,w  )
	);
*
* Use w = Exp(2*pi*I/3), so
* 	w^3 = 1 and 1 + w + w^2 = 0.
